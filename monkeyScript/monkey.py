...
def runmonkey():
    ...
    # os.popen('adb -s N8K7N17606003031 shell monkey -p abc.apple.emoji.theme.gif.keyboard --throttle 10 --ignore-timeouts --ignore-crashes -s 112 -v 100')
...
def installTouchPal():
    ...
    os.popen('adb install -r TouchPal.apk')
